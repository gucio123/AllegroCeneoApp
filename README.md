This is the project of a web app, which uses Allegro and Ceneo RestApi. The goal of this project is to create an app which simplifies shopping with Allegro or Ceneo.
